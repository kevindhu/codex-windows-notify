...
$form.ForeColor = [System.Drawing.Color]::FromArgb(244, 245, 247)
$form.Size = New-Object System.Drawing.Size(460, 156)
$form.Padding = New-Object System.Windows.Forms.Padding(20, 16, 20, 18)
$form.Cursor = [System.Windows.Forms.Cursors]::Hand

function New-CardOutline {
    param([float]$Width, [float]$Height, [float]$Inset = 0)
    $diameter = 20.0
    $path = New-Object System.Drawing.Drawing2D.GraphicsPath
    $right = $Width - $Inset - $diameter
    $bottom = $Height - $Inset - $diameter
    $path.AddArc($Inset, $Inset, $diameter, $diameter, 180, 90)
    $path.AddArc($right, $Inset, $diameter, $diameter, 270, 90)
    $path.AddArc($right, $bottom, $diameter, $diameter, 0, 90)
    $path.AddArc($Inset, $bottom, $diameter, $diameter, 90, 90)
    $path.CloseFigure()
    return $path
}

$updateCorners = {
    $outline = New-CardOutline $form.ClientSize.Width $form.ClientSize.Height
    try {
...
$form.Add_SizeChanged($updateCorners)
& $updateCorners

$statusColor = [System.Drawing.Color]::FromArgb(133, 199, 170)
if ($title -eq 'Codex needs attention') {
    $statusColor = [System.Drawing.Color]::FromArgb(222, 185, 119)
}
$form.Add_Paint({
    param($sender, $eventArgs)
    $eventArgs.Graphics.SmoothingMode = [System.Drawing.Drawing2D.SmoothingMode]::AntiAlias
    $outline = New-CardOutline $form.ClientSize.Width $form.ClientSize.Height 0.5
    $borderPen = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(65, 67, 73), 1)
    $statusBrush = New-Object System.Drawing.SolidBrush($statusColor)
    try {
        $eventArgs.Graphics.DrawPath($borderPen, $outline)
        $eventArgs.Graphics.FillEllipse($statusBrush, 20, 26, 6, 6)
    } finally {
        $statusBrush.Dispose()
        $borderPen.Dispose()
        $outline.Dispose()
...
$titleLabel.ForeColor = $form.ForeColor
$titleLabel.AutoSize = $false
$titleLabel.AutoEllipsis = $true
$titleLabel.UseMnemonic = $false
$titleLabel.Location = New-Object System.Drawing.Point(34, 16)
$titleLabel.Size = New-Object System.Drawing.Size(406, 28)
...
$messageLabel.ForeColor = [System.Drawing.Color]::FromArgb(199, 202, 209)
$messageLabel.AutoSize = $false
$messageLabel.AutoEllipsis = $true
$messageLabel.UseMnemonic = $false
$messageLabel.Location = New-Object System.Drawing.Point(20, 52)
$messageLabel.Size = New-Object System.Drawing.Size(420, 86)
